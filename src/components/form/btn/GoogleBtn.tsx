...
const GoogleBtn: React.FC<Props> = ({ name }) => {
  const [isLoading, setIsLoading] = useState<boolean>(false);

  const loginWithGoogle = async () => {
    setIsLoading(true); // Cambia isLoading a true al iniciar sesión
    try {
      ...
      setIsLoading(false); // Cambia isLoading a false cuando la operación de inicio de sesión haya terminado
    }
  };

  return (
    <div className="buttons-container" onClick={loginWithGoogle}>
